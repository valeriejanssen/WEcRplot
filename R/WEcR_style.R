#' Add the WEcR theme to a ggplot chart
#'
#' Based on bbc_style
#'
#' This function allows you to add the WEcR theme to your ggplot graphics.
#' @keywords WEcR_style
#'
#' @export
#'
...
WEcR_style <- function(){
  ...
  ggplot2::theme(
    ...
    plot.title = ggplot2::element_text(family=font,
                                       size=28,
                                       face="bold",
                                       color="#34B233"), #WEcR Main colour - WEcR green
    ...
    #Using WEcR colours for the content of the graph
    ...
    legend.text = ggplot2::element_text(family=font,
                                        size=18,
                                        color="#222222"), #WEcR support colour - Warm Grey
