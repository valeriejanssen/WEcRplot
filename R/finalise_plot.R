...
#'
#' Running this function will save your plot with the correct guidelines for publication for a WEcR file.
#' It will left align your title, subtitle and source, add the WEcR blocks at the bottom right and save it to your specified location.
...
#'  which needs to be a WEcR file - defaults to WEcR blocks image that sits within the data folder of your package
...
finalise_plot <- function(plot_name,
                          ...
                          width_pixels=640,
                          height_pixels=450,
                          #logo_image_path = file.path(system.file("data", package = 'WEcRplot'),"placeholder.png")) {
                          logo_image_path = file.path("placeholder.png")) {
